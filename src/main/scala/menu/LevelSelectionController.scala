...
/** The controller to be used by the level selection page in the main menu.
  ...
  * information are about the number of [[Level]] currently playable and the services allow for the
  * start of a new game given the index of the selected [[Level]]. Moreover, it is always possible to
