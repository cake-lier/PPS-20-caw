...
/** A cell, an element of a [[it.unibo.pps.caw.common.model.Board]] in the game.
  *
...
/** The [[Cell]] that can rotate other cells.
  *
...
/** The [[Cell]] that can generate other cells.
  *
...
/** The [[Cell]] to be killed by the player.
  *
...
/** The [[Cell]] that can move on its own.
  *
...
/** The [[Cell]] cell that can be pushed around.
  *
...
/** The [[Cell]] capable of deleting other cells.
  *
  * This cell is capable of deleting other cells, no matter their type. This means that a deleter cell is capable of deleting a
  * cell of its own kind. If generated by a [[GeneratorCell]] when there is already a cell in front of the generator, the newly
  * created deleter will delete this cell and replace it. This is true also if the cell in front of the generator cell is another
  * deleter.
  */
trait DeleterCell extends Cell
