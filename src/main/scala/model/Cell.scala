...
object EnumHelper{
   ...
   * @param stringCellTypes: the value of [[CellTypes]] as string*/
   ...
   * @param stringOrientation: the value of [[Orientation]] as string*/
   ...
   * @param stringMovement: the value of [[AllowedMovement]] as string*/
   ...
   * @param stringRotationDirection: the value of [[RotationDirection]] as string*/
 ...
 * @param rotationDirection: the [[RotationDirection]]*/
 ...
 * @param position: the coordinates of the cell
 * @param playable: if the cell is playable (is in the [[PlayableArea]])
 * @param orientation: the [[Orientation]] in the area */
 ...
 * @param position: the coordinates of the cell
 * @param playable: if the cell is playable (is in the [[PlayableArea]])
 * @param allowedMovement: the [[AllowedMovement]] */
