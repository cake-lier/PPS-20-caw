...
/** The "inAnArea" word, used for specifying the [[it.unibo.pps.caw.common.model.Dimensions]] of an area of the
  * [[it.unibo.pps.caw.common.model.Level]] which is populated with the same type of cells.
  *
...
trait InAnAreaWord[A <: FollowingInAnAreaWord] {
  ...
  /** Allows to use the "inAnArea" word in a sentence written in the DSL, specifying the
    * [[it.unibo.pps.caw.common.model.Dimensions]] of an area of the [[it.unibo.pps.caw.common.model.Level]] which is populated
    * with the same type of cells. It returns the [[FollowingInAnAreaWord]] to use next for continuing the sentence.
    *
    * @param width
...
object InAnAreaWord {
  ...
  /** Returns a new instance of the [[InAnAreaWord]] trait. It needs a function which can consume the
    * [[it.unibo.pps.caw.common.model.Dimensions]] that the user specifies through the use of this "inAnArea" word and which can
    * return a [[FollowingInAnAreaWord]] that the user must then use for continuing the sentence.
    *
    * @param fun
    *   the function for consuming the [[it.unibo.pps.caw.common.model.Dimensions]] the user specifies through this "inAnArea"
    *   word and which returns the [[FollowingInAnAreaWord]] to use next in the sentence
    * @tparam A
