...
//    robot
//      .drag(getImageViewByCoordinates(getGameBoard(robot))(2, 2)(CellImage.MoverRight.image)(robot), MouseButton.PRIMARY)
//      .dropBy(0, stageHeight * 0.2)
//      .drop()
//
...
//    getImageViewByCoordinates(getGameBoard(robot))(3, 4)(CellImage.MoverRight.image)(robot)
//  }
//
...
//    robot.drag(getImageViewByCoordinates(gameBoard)(3, 4)(CellImage.MoverRight.image)(robot)).dropBy(0, -stageHeight * 0.2)
//    robot.drag(getImageViewByCoordinates(gameBoard)(7, 4)(CellImage.Enemy.image)(robot)).dropBy(0, -stageHeight * 0.2)
//  }
//
...
//    getImageViewByCoordinates(getGameBoard(robot))(2, 4)(CellImage.MoverRight.image)(robot)
//  }
//
...
//    getImageViewByCoordinates(gameBoard)(3, 4)(CellImage.MoverRight.image)(robot)
//    // it should display the game simulation by 2 step
//    clickOnStepSimulationButton(robot)
//    // after 2 steps, the mover cell should be found at coordinate (4,4)
//    getImageViewByCoordinates(gameBoard)(4, 4)(CellImage.MoverRight.image)(robot)
