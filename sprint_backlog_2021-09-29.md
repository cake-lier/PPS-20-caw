#### Sprint goal:
Rifinire tutto il codice realizzato, effettuando refactoring e migliorando la documentazione già inserita nel codice.
...
<table>
    ...
    <tbody>
        <tr>
            <td rowspan="14">Miglioramento del codice e della documentazione</td>
        ...
        <tr>
            <td>Necessità di EditorModel di aggiungere il muro cornice</td>
            <td>Lorenzo Gardini</td>
            <td>2</td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>Iniezione di RulesEngine in GameModel</td>
            <td>Lorenzo Gardini</td>
            <td>2</td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>Refactor di RulesEngine perché sia PROLOG-independent</td>
            <td>Lorenzo Gardini</td>
            <td>2</td>
            <td></td>
            <td></td>
